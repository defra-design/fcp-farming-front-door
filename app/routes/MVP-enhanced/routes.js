...
module.exports = function (router, _myData) {
    ...
    router.post('/search-criteria-answer', function (request, response) {
        ...
        if (searchCriteria == "int-sr-cusName") {
            response.redirect("/MVP-enhanced/internal-search-customer-name")
        } else {
            response.redirect("/MVP-enhanced/internal-search")
        }
    })
    ...
    router.post('/legal-answer', function (request, response) {
        ...
        if (legalBus == "Charitable incorporated organisation (CIO)") {
            response.redirect("MVP-enhanced/business-details-legal-charity")
        }
        else if (legalBus == "Charitable trust") {
            response.redirect("MVP-enhanced/business-details-legal-check")
        }
            ...
            response.redirect("MVP-enhanced/business-details-legal-company")
        }
    })
